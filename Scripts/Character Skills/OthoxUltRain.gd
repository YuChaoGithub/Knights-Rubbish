...
var rain_sprites = [
    preload("res://Graphics/Characters/Othox Codox/Letters/killK.png"),
    preload("res://Graphics/Characters/Othox Codox/Letters/killI.png"),
    preload("res://Graphics/Characters/Othox Codox/Letters/killL.png"),
    preload("res://Graphics/Characters/Othox Codox/Letters/killL.png")
]
